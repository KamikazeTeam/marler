...
__all__ = ['ResNet3d', 'resnet3d10', 'resnet3d18', 'resnet3d34', 'resnet3d50', 'resnet3d101', 'resnet3d152',
           'resnet3d200']
...
class Network(nn.Module):
    def __init__(self, num_inputs, num_outputs, paraslist, block=BasicBlock, shortcut_type='B'):
        ...
        self.conv1 = nn.Conv3d(num_inputs[3], para[9], kernel_size=(para[2], para[0], para[1]),
                               stride=(para[5], para[3], para[4]), padding=(para[8], para[6], para[7]), bias=False)
